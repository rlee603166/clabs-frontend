          ...
          <div className="backdrop-blur-md bg-[#252528]/80 border border-[#374151]/30 rounded-2xl px-6 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <Button className="bg-[#3b82f6] hover:bg-[#3b82f6]/90 text-white px-4 py-2 rounded-lg text-sm font-medium">
                  Request Access
                </Button>
              </div>
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 px-6 py-8 space-y-6">
                ...
                <Button className="w-full bg-[#3b82f6] hover:bg-[#3b82f6]/90 text-white px-4 py-3 rounded-lg font-medium mt-8">
                  Request Access
                </Button>
              </div>
            </div>
